'''Переворот строки 🙃
Вам доступен текстовый файл text.txt 
с одной строкой текста. 
Напишите программу, 
которая выводит на экран эту строку 
в обратном порядке.
...
по (ссылке)[https://stepik.org/media/attachments/lesson/530408/text.txt].
'''
