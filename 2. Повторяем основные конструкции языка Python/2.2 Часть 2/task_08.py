...
Примечание. 
Правила игры стандартные: ножницы режут бумагу. 
...
if t == r:
    print("ничья")
elif (t == game[0] and r in [game[1], game[3]]) or \
    (t == game[1] and r in [game[2], game[3]]) or \
    (t == game[2] and r in [game[0], game[4]]) or \
    (t == game[3] and r in [game[2], game[4]]) or \
    (t == game[4] and r in [game[0], game[1]]):
        print("Тимур")
else:
    print("Руслан")