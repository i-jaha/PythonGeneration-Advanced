...
map() и filter() пошагово: 
    1) Удаляет из списка numbers 
    все нечетные элементы, 
    бо́льшие 47;
    2) Делит все четные элементы нацело 
...
Примечание. 
Используйте анонимную функцию в качестве критерия фильтрации.
'''
...
filtered_numbers = filter(lambda x: not (x > 47 and x % 2 != 0), numbers)
