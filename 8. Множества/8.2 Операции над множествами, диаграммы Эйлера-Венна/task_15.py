...
Ученики 10-го класса онлайн-школы BEEGEEK получили задание 
...
Программа должна вывести три числа в соответствии с условием задачи, 
...
two_books = ab + bc + ac - 3 * t
total_readers = n + m + k - ab - bc - ac + t
one_book = total_readers - two_books - t
no_books = a - total_readers
